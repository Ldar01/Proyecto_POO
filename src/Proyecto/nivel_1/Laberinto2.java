 ...
 */
public final class Laberinto2 extends JFrame {
    ...
    public Laberinto2(int cantFantasmas, String personaje_png, int velocidad, int alcance) {
    ...
    public void verificarFin(){
        FinNivelHilo2 fin = new FinNivelHilo2(fantasmas, this);
        fin.start();
    }
